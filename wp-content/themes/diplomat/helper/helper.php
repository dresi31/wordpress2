...
class TMM_Helper {    
    ...
    public static function get_social_buttons_list() {
        return array(
            'twitter' => esc_html__('Twitter', 'diplomat'),
            'facebook' => esc_html__('Facebook', 'diplomat'),
            'pinterest' => esc_html__('Pinterest', 'diplomat'),
            'google+' => esc_html__('Google+', 'diplomat'),
            'rss' => esc_html__('RSS', 'diplomat')
        );
    }
    ...
    public static function get_image($img_src, $alias, $show_cap = true) {
        ...
        $al = explode('*', $alias);
        $new_img_src = aq_resize($img_src, $al[0], $al[1], false);
...
//Custom page navigation
    ...
    public static function get_monts_names($num) {
        $monthes = array(
            0 => esc_html__('January', 'diplomat'),
            1 => esc_html__('February', 'diplomat'),
            2 => esc_html__('March', 'diplomat'),
            3 => esc_html__('April', 'diplomat'),
            4 => esc_html__('May', 'diplomat'),
            5 => esc_html__('June', 'diplomat'),
            6 => esc_html__('July', 'diplomat'),
            7 => esc_html__('August', 'diplomat'),
            8 => esc_html__('September', 'diplomat'),
            9 => esc_html__('October', 'diplomat'),
            10 => esc_html__('November', 'diplomat'),
            11 => esc_html__('December', 'diplomat'),
        );
    ...
    public static function get_short_monts_names($num) {
        $monthes = array(
            0 => esc_html__('jan', 'diplomat'),
            1 => esc_html__('feb', 'diplomat'),
            2 => esc_html__('mar', 'diplomat'),
            3 => esc_html__('apr', 'diplomat'),
            4 => esc_html__('may', 'diplomat'),
            5 => esc_html__('jun', 'diplomat'),
            6 => esc_html__('jul', 'diplomat'),
            7 => esc_html__('aug', 'diplomat'),
            8 => esc_html__('sep', 'diplomat'),
            9 => esc_html__('oct', 'diplomat'),
            10 => esc_html__('nov', 'diplomat'),
            11 => esc_html__('dec', 'diplomat'),
        );
    ...
    public static function get_days_of_week($num) {
        $days = array(
            0 => esc_html__('Sunday', 'diplomat'),
            1 => esc_html__('Monday', 'diplomat'),
            2 => esc_html__('Tuesday', 'diplomat'),
            3 => esc_html__('Wednesday', 'diplomat'),
            4 => esc_html__('Thursday', 'diplomat'),
            5 => esc_html__('Friday', 'diplomat'),
            6 => esc_html__('Saturday', 'diplomat'),
        );
	...
	function get_meta_info() {
		...
		if (get_comments_number() == 1) {
			$comments_text =  esc_html__(' Comment', 'diplomat');
		} else {
			$comments_text =  esc_html__(' Comments', 'diplomat');
		}
		$output = '<span class="post-entry-date">' . get_the_date('M d, Y') .' ,</span>';
		$output .= '<span>' . esc_html__('by ', 'diplomat') . the_author() . ',</span>';
		$output .= '<span>' . esc_html__(' in ', 'diplomat') . get_the_category_list(', ') . ', ' . get_comments_number() . ' ' . $comments_text . '</span>';
		return $output;
	}
	    ...
	    if ( is_single() || is_page() || is_archive() || $is_page_for_posts ) {
		    ...
		    if (is_category() || is_single() || is_tax()) {
			    ...
			    if (is_post_type_archive('post')) {
				    $text = esc_html__('Blog Archives', 'diplomat');
			    }
    ...
    public static function get_the_category_list($separator = '', $parents = '', $post_id = false) {
        ...
        if (empty($categories))
            return apply_filters('the_category', esc_html__('Uncategorized', 'diplomat'), $separator, $parents);
    ...
    public static function get_fontello_icons(){
        $fontello_icons = array(
            'icon-adjust' => esc_html__('Icon Adjust', 'diplomat'),
            'icon-anchor' => esc_html__('Icon Anchor', 'diplomat'),
            'icon-asterisk' => esc_html__('Icon Asterisk', 'diplomat'),
            'icon-barcode' => esc_html__('Icon Barcode', 'diplomat'),
            'icon-beaker' => esc_html__('Icon Beaker', 'diplomat'),
            'icon-beer' => esc_html__('Icon Beer', 'diplomat'),
            'icon-bell' => esc_html__('Icon Bell', 'diplomat'),
            'icon-book' => esc_html__('Icon Book', 'diplomat'),
            'icon-bookmark-empty' => esc_html__('Icon Bookmark Empty', 'diplomat'),
            'icon-bookmark' => esc_html__('Icon Bookmark', 'diplomat'),
            'icon-briefcase' => esc_html__('Icon Briefcase', 'diplomat'),
            'icon-bullhorn' => esc_html__('Icon Bullhorn', 'diplomat'),
            'icon-bullseye' => esc_html__('Icon Bullseye', 'diplomat'),
            'icon-calendar-empty' => esc_html__('Icon Calendar Empty', 'diplomat'),
            'icon-calendar-inv' => esc_html__('Icon Calendar Inv', 'diplomat'),
            'icon-calendar' => esc_html__('Icon Calendar', 'diplomat'),
            'icon-camera' => esc_html__('Icon Camera', 'diplomat'),
            'icon-certificate' => esc_html__('Icon Certificate', 'diplomat'),
            'icon-check-empty' => esc_html__('Icon Check Empty', 'diplomat'),
            'icon-check' => esc_html__('Icon Check', 'diplomat'),
            'icon-circle' => esc_html__('Icon Circle', 'diplomat'),
            'icon-code' => esc_html__('Icon Code', 'diplomat'),
            'icon-coffee' => esc_html__('Icon Coffee', 'diplomat'),
            'icon-cog' => esc_html__('Icon Cog', 'diplomat'),
            'icon-cogs' => esc_html__('Icon Cogs', 'diplomat'),
            'icon-comment-alt' => esc_html__('Icon Comment Alt', 'diplomat'),
            'icon-comment' => esc_html__('Icon Comment', 'diplomat'),
            'icon-credit-card' => esc_html__('Icon Credit Card', 'diplomat'),
            'icon-crop' => esc_html__('Icon Crop', 'diplomat'),
            'icon-desktop' => esc_html__('Icon Desktop', 'diplomat'),
            'icon-download-alt' => esc_html__('Icon Download Alt', 'diplomat'),
            'icon-download' => esc_html__('Icon Download', 'diplomat'),
            'icon-edit' => esc_html__('Icon Edit', 'diplomat'),
            'icon-eraser' => esc_html__('Icon Eraser', 'diplomat'),
            'icon-exchange' => esc_html__('Icon Exchange', 'diplomat'),
            'icon-exclamation' => esc_html__('Icon Exclamation', 'diplomat'),
            'icon-fighter-jet' => esc_html__('Icon Fighter Jet', 'diplomat'),
            'icon-filter' => esc_html__('Icon Filter', 'diplomat'),
            'icon-fire' => esc_html__('Icon Fire', 'diplomat'),
            'icon-flag-checkered' => esc_html__('Icon Flag Checkered', 'diplomat'),
            'icon-flag' => esc_html__('Icon Flag', 'diplomat'),
            'icon-folder-close' => esc_html__('Icon Folder Close', 'diplomat'),
            'icon-folder-open' => esc_html__('Icon Folder Open', 'diplomat'),
            'icon-food' => esc_html__('Icon Food', 'diplomat'),
            'icon-frown' => esc_html__('Icon Frown', 'diplomat'),
            'icon-gamepad' => esc_html__('Icon Gamepad', 'diplomat'),
            'icon-gift' => esc_html__('Icon Gift', 'diplomat'),
            'icon-glass' => esc_html__('Icon Glass', 'diplomat'),
            'icon-globe' => esc_html__('Icon Globe', 'diplomat'),
            'icon-globe-6' => esc_html__('Icon Globe 6', 'diplomat'),
            'icon-group' => esc_html__('Icon Group', 'diplomat'),
            'icon-hdd' => esc_html__('Icon Hdd', 'diplomat'),
            'icon-headphones' => esc_html__('Icon Headphones', 'diplomat'),
            'icon-heart-empty' => esc_html__('Icon Heart Empty', 'diplomat'),
            'icon-heart' => esc_html__('Icon Heart', 'diplomat'),
            'icon-home' => esc_html__('Icon Home', 'diplomat'),
            'icon-inbox' => esc_html__('Icon Inbox', 'diplomat'),
            'icon-info' => esc_html__('Icon Info', 'diplomat'),
            'icon-key' => esc_html__('Icon Key', 'diplomat'),
            'icon-keyboard' => esc_html__('Icon Keyboard', 'diplomat'),
            'icon-laptop' => esc_html__('Icon Laptop', 'diplomat'),
            'icon-leaf' => esc_html__('Icon Leaf', 'diplomat'),
            'icon-lemon' => esc_html__('Icon Lemon', 'diplomat'),
            'icon-level-down' => esc_html__('Icon Level Down', 'diplomat'),
            'icon-level-up' => esc_html__('Icon Level Up', 'diplomat'),
            'icon-lightbulb' => esc_html__('Icon Lightbulb', 'diplomat'),
            'icon-lock' => esc_html__('Icon Lock', 'diplomat'),
            'icon-magic' => esc_html__('Icon Magic', 'diplomat'),
            'icon-magnet' => esc_html__('Icon Magnet', 'diplomat'),
            'icon-meh' => esc_html__('Icon Meh', 'diplomat'),
            'icon-megaphone' => esc_html__('Icon Megaphone', 'diplomat'),
            'icon-money' => esc_html__('Icon Money', 'diplomat'),
            'icon-move' => esc_html__('Icon Move', 'diplomat'),
            'icon-music' => esc_html__('Icon Music', 'diplomat'),
            'icon-off' => esc_html__('Icon Off', 'diplomat'),
            'icon-ok-circle' => esc_html__('Icon Ok Circle', 'diplomat'),
            'icon-ok' => esc_html__('Icon Ok', 'diplomat'),
            'icon-pencil' => esc_html__('Icon Pencil', 'diplomat'),
            'icon-picture' => esc_html__('Icon Picture', 'diplomat'),
            'icon-plane' => esc_html__('Icon Plane', 'diplomat'),
            'icon-paper-plane-2' => esc_html__('Icon Paper Plane 2', 'diplomat'),
            'icon-params' => esc_html__('Icon Params', 'diplomat'),
            'icon-pencil-7' => esc_html__('Icon Pencil 7', 'diplomat'),
            'icon-plus' => esc_html__('Icon Plus', 'diplomat'),
            'icon-print' => esc_html__('Icon Print', 'diplomat'),
            'icon-qrcode' => esc_html__('Icon Grcode', 'diplomat'),
            'icon-question' => esc_html__('Icon Question', 'diplomat'),
            'icon-quote-left' => esc_html__('Icon Quote Left', 'diplomat') ,
            'icon-quote-right' => esc_html__('Icon Quote Right', 'diplomat'),
            'icon-reply-all' => esc_html__('Icon Reply All', 'diplomat'),
            'icon-reply' => esc_html__('Icon Reply', 'diplomat'),
            'icon-resize-horizontal' => esc_html__('Icon Resize Horizontal', 'diplomat'),
            'icon-resize-vertical' => esc_html__('Icon Resize Vertical', 'diplomat'),
            'icon-retweet' => esc_html__('Icon Retweet', 'diplomat'),
            'icon-road' => esc_html__('Icon Road', 'diplomat'),
            'icon-rocket' => esc_html__('Icon Rocket', 'diplomat'),
            'icon-search' => esc_html__('Icon Search', 'diplomat'),
            'icon-share' => esc_html__('Icon Share', 'diplomat'),
            'icon-shield' => esc_html__('Icon Shield', 'diplomat'),
            'icon-signal' => esc_html__('Icon Signal', 'diplomat'),
            'icon-sitemap' => esc_html__('Icon Sitemap', 'diplomat'),
            'icon-smile' => esc_html__('Icon Smile', 'diplomat'),
            'icon-sort-down' => esc_html__('Icon Sort Down', 'diplomat'),
            'icon-sort-up' => esc_html__('Icon Sort Up', 'diplomat'),
            'icon-sort' => esc_html__('Icon Sort', 'diplomat'),
            'icon-spinner' => esc_html__('Icon Spinner', 'diplomat'),
            'icon-star-empty' => esc_html__('Icon Star Empty', 'diplomat'),
            'icon-star-half' => esc_html__('Icon Star Half', 'diplomat'),
            'icon-star' => esc_html__('Icon Star', 'diplomat'),
            'icon-tablet' => esc_html__('Icon Tablet', 'diplomat'),
            'icon-tag' => esc_html__('Icon Tag', 'diplomat'),
            'icon-tags' => esc_html__('Icon Tags', 'diplomat'),
            'icon-tasks' => esc_html__('Icon Tasks', 'diplomat'),
            'icon-terminal' => esc_html__('Icon Terminal', 'diplomat'),
            'icon-thumbs-down' => esc_html__('Icon Thumbs Down', 'diplomat'),
            'icon-thumbs-up' => esc_html__('Icon Thumbs Up', 'diplomat'),
            'icon-thumbs-up-4' => esc_html__('Icon Thumbs Up 4', 'diplomat'),
            'icon-thumbs-up-5' => esc_html__('Icon Thumbs Up 5', 'diplomat'),
            'icon-thumbs-up-alt' => esc_html__('Icon Thumbs Up Alt', 'diplomat'),
            'icon-ticket' => esc_html__('Icon Ticket', 'diplomat'),
            'icon-tint' => esc_html__('Icon Tin', 'diplomat'),
            'icon-trash' => esc_html__('Icon Trash', 'diplomat'),
            'icon-trophy' => esc_html__('Icon Trophy', 'diplomat'),
            'icon-truck' => esc_html__('Icon Truck', 'diplomat'),
            'icon-umbrella' => esc_html__('Icon Umbrella', 'diplomat'),
            'icon-upload' => esc_html__('Icon Upload', 'diplomat'),
            'icon-user-md' => esc_html__('Icon User Md', 'diplomat'),
            'icon-user' => esc_html__('Icon User', 'diplomat'),
            'icon-volume-down' => esc_html__('Icon Volume Down', 'diplomat'),
            'icon-volume-off' => esc_html__('Icon Volume Off', 'diplomat'),
            'icon-volume-up' => esc_html__('Icon Volume Up', 'diplomat'),
            'icon-wrench' => esc_html__('Icon Wrench', 'diplomat'),
            'icon-zoom-in' => esc_html__('Icon Zoom In', 'diplomat'),
            'icon-zoom-out' => esc_html__('Icon Zoom Out', 'diplomat')
        );
